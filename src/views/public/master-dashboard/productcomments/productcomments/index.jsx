                ...
                <Card shadow="md" padding="lg" radius="md" withBorder>
                  <Stack spacing="md">
                    <Text size="lg" weight={500} align="center">
                      Manage Your Product Comments Efficiently
                    </Text>
                    ...
                    <Group position="center" spacing="xl">
                      ...
                      <MantineNavLink 
                        component={NavLink} 
                        to="/master-dashboard/product-comments/add-batch-product-comments" 
                        label="➕ Add Batch Product Comments" 
                        variant="filled"
                        sx={(theme) => ({
                          borderRadius: theme.radius.md,
                          padding: "10px 20px",
