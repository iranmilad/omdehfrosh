        ...
        return (
          <Container size="lg" py="xl">
            <Title align="center" mb="lg" order={2} sx={{ fontWeight: 700 }}>
              WideSlider Management
            </Title>
      
            <Card shadow="md" padding="lg" radius="md" withBorder>
              <Stack spacing="md">
                <Text size="lg" weight={500} align="center">
                  Manage Your WideSlider Efficiently
                </Text>
                ...
                <Group position="center" spacing="xl">
                  ...
                  <MantineNavLink 
                    component={NavLink} 
                    to="/master-dashboard/wideslider/add-batch-widesliders" 
                    label="➕ Add Batch widesliders" 
                    variant="filled"
                    sx={(theme) => ({
                      borderRadius: theme.radius.md,
                      padding: "10px 20px",
