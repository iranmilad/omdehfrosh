            ...
            <Card shadow="md" padding="lg" radius="md" withBorder>
              <Stack spacing="md">
                <Text size="lg" weight={500} align="center">
                  Manage Your Purchased Products Efficiently
                </Text>
                ...
                <Group position="center" spacing="xl">
                  ...
                  <MantineNavLink 
                    component={NavLink} 
                    to="/master-dashboard/purchasedproducts/add-batch-purchasedproducts" 
                    label="➕ Add Batch Purchased Products" 
                    variant="filled"
                    sx={(theme) => ({
                      borderRadius: theme.radius.md,
                      padding: "10px 20px",
