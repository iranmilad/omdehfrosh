        ...
        return (
          <Container size="lg" py="xl">
            <Title align="center" mb="lg" order={2} sx={{ fontWeight: 700 }}>
              Fast Order Category Management
            </Title>
      
            <Card shadow="md" padding="lg" radius="md" withBorder>
              <Stack spacing="md">
                <Text size="lg" weight={500} align="center">
                  Manage Your Fast Order Categories Efficiently
                </Text>
                ...
                <Group position="center" spacing="xl">
                  <MantineNavLink 
                    ...
                    label="📦 All Fast Order Categories" 
                    variant="filled"
                    sx={(theme) => ({
                  ...
                  <MantineNavLink 
                    component={NavLink} 
                    to="/master-dashboard/fastordercategories/add-batch-fast-order-categories" 
                    label="➕ Add Batch Fast Order Categories" 
                    variant="filled"
                    sx={(theme) => ({
                      borderRadius: theme.radius.md,
                      padding: "10px 20px",
...
export default FastOrderCategories;
