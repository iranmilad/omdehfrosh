            ...
            <Card shadow="md" padding="lg" radius="md" withBorder>
              <Stack spacing="md">
                ...
                <Group position="center" spacing="xl">
                  ...
                  <MantineNavLink 
                    component={NavLink} 
                    to="/master-dashboard/myaccount-tickets/add-batch-myaccount-tickets" 
                    label="➕ Add Batch Tickets" 
                    variant="filled"
                    sx={(theme) => ({
                      borderRadius: theme.radius.md,
                      padding: "10px 20px",
...
export default MyAccountTickets;
