            ...
            <Card shadow="md" padding="lg" radius="md" withBorder>
              <Stack spacing="md">
                <Text size="lg" weight={500} align="center">
                  Manage Your Category Filters Efficiently
                </Text>
                ...
                <Group position="center" spacing="xl">
                  ...
                  <MantineNavLink 
                    component={NavLink} 
                    to="/master-dashboard/categoryfilters/add-batch-categoryfilters" 
                    label="➕ Add Batch Category Filters" 
                    variant="filled"
                    sx={(theme) => ({
                      borderRadius: theme.radius.md,
                      padding: "10px 20px",
