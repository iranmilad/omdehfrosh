        ...
        return (
          <Container size="lg" py="xl">
            <Title align="center" mb="lg" order={2} sx={{ fontWeight: 700 }}>
              Trend Products Management
            </Title>
      
            <Card shadow="md" padding="lg" radius="md" withBorder>
              <Stack spacing="md">
                <Text size="lg" weight={500} align="center">
                  Manage Trend Products Efficiently
                </Text>
                ...
                <Group position="center" spacing="xl">
                  ...
                  <MantineNavLink 
                    component={NavLink} 
                    to="/master-dashboard/trendproducts/add-batch-trend-products" 
                    label="➕ Add Batch Trend Products" 
                    variant="filled"
                    sx={(theme) => ({
                      borderRadius: theme.radius.md,
                      padding: "10px 20px",
