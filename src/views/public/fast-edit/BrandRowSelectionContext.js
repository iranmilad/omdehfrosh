// BrandRowSelectionContext.js - For Fast Edit Brand Component
import React, { createContext, useContext, useState, useEffect } from 'react';
import Cookies from 'js-cookie';

const BrandRowSelectionContext = createContext();

const CHECKED_ROWS_COOKIE = 'brand_fast_edit_checked_rows';
const SELECTED_ROW_COOKIE = 'brand_fast_edit_selected_row';
