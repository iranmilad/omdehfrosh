// src\views\public\fast-edit\savedfilters\categorymode\SavedFiltersModalCategory.jsx
...
const SavedFiltersModalCategory = ({
  opened,
  onClose,
  isMobile,
  COOKIE_NAME,
  ...
  const SAVE_FILTERS_SLUG = "category-fast-edit";
  ...
  }, [COOKIE_NAME, setFilters, setSearchType, setSelectedRow, dispatch, onClose, setFilterCategoryStorage, setFilterCategorySubCategoryStorage, setFilterCategorySubCategoryBrandsStorage, setLocalFilters, clearAll]);
  ...
  const handleFilterClick = useCallback((filter) => {
    ...
    onClose();
  }, [COOKIE_NAME, setFilters, setSearchType, setSelectedRow, dispatch, onClose, isEditMode, editingFilterId, setFilterCategoryStorage, setFilterCategorySubCategoryStorage, setFilterCategorySubCategoryBrandsStorage, setLocalFilters]);
...
export default SavedFiltersModalCategory;