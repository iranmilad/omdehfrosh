...
// Action to batch import categories data for fast order page
export const batchImportFastOrderPageCategories = createAsyncThunk(
  "fastOrderPageCategories/batchImport",
  async ({ categoriesFastOrder }, { rejectWithValue }) => {
    try {
